...
export default function GameOver({ winner, restartFun }) {
  return (
    <div className="absolute text-white top-1/2 p-8 rounded-lg flex flex-col justify-between transform -translate-y-1/2 left-0 right-0 mx-auto bg-gray-800 bg-opacity-75 w-[400px] h-[400px]">
      <span>
