          ...
          >
            {row.map((playerSymbol, colIndex) => (
              <button
                ...
                className="col select-none active:w-[90%] text-6xl active:text-5xl bg-gradient-to-tr from-blue-500 to-blue-200 hover:from-blue-700 hover:to-blue-300 duration-400 transition-all w-full rounded mx-auto aspect-square"
                key={colIndex}
                onClick={() => {
